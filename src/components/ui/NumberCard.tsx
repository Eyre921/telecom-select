    ...
    return (
        <div className={cardClasses} onClick={() => isAvailable && onClick(number)}>
            ...
            {(number.isPremium && isAvailable) && (
                <div className="absolute -top-px -right-px px-3 py-1 text-xs font-bold text-white bg-gradient-to-r from-orange-500 to-red-500 rounded-bl-lg rounded-tr-xl shadow-md">
            ...
            {!isAvailable && statusText && (
                <div className="absolute -top-px -right-px px-3 py-1 text-xs font-bold text-white bg-gray-500 rounded-bl-lg rounded-tr-xl">
                    {statusText}
                </div>
            )}
